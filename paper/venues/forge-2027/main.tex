...
displayed 31.7\%, reversing order with Qwen2.5-Coder-0.5B. Kendall's $\tau_b$
was 0.8 and the paired difference was $-21.95$ percentage points
($[-28.66,-15.85]$). Removing only the newline restored the displayed order;
the other four models moved by at most three tasks. A completed $2\times2$
